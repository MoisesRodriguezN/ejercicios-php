...
$_SESSION['catalogo'] = array (
  "cod1" => array( "nombre" => "Samsung galaxy s7", "precio" => 720, "imagen" => "imagenes/galaxy7.png", "detalle" => "4GB RAM 32GB INTERNA CPU QUAD CORE 2.2GHZ", "categoria" => ""),
  "cod2" => array( "nombre" => "LG G4", "precio" => 30, "imagen" => "imagenes/lg4.png", "detalle" => "3GB RAM 16GB INTERNA CPU QUAD CORE 1.8GHZ", "categoria" => "cod1"),
  ...
  "cod4" => array( "nombre" => "SAMSUNGJ5", "precio" => 250, "imagen" => "imagenes/samsungj5.png" , "detalle" => "1GB RAM 16GB INTERNA CPU QUAD CORE 1.6GHZ" , "categoria" => "cod2" , "categoria2" => "cod1")
  );
  ...
  <body>    
    ...
    <?php
        ...
        foreach ($_SESSION['catalogo'] as $codigo => $producto) {
          if(!isset($codCategoria) || $producto['categoria'] == $codCategoria || $codCategoria == "todas" || $producto['categoria2'] == "cod1" || $producto['categoria2'] == "cod2"){
          ...
          <a id="<?= $codigo?>">
            ...
            <span style="color:green"> <?= $_SESSION['categoria'][$producto['categoria']]?> </span><br>
            <span style="color:green"> <?= $_SESSION['categoria'][$producto['categoria2']]?></span>
      ...
      foreach ($_SESSION["carrito"] as $codigo => $cantidad) {
        if($cantidad > 0){
          ...
          ?>
            ...
            <form action="confirmaElimPro.php" method="post">  
              <input type="hidden" name="codigo" value="<?= $codigo?>"/>
              <input type="hidden" name="codCategoria" value="<?= $codCategoria?>"/>
